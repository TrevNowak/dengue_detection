...
# Threshold-Based Outbreak Detection
...
# Severe Outbreak Scenario (Higher Threshold + Weather Factor)
...
# Convert Outbreak Status to Binary for Evaluation
...
# Ground truth assumption: Using severe outbreak as actual outbreak (for evaluation purposes)
...
# Plot the Simulated Dengue Cases with Outbreak Detection
